...
<h1>Generate LML from a GVQ metadata XML file</h1>

<form action="http://geoviqua.dev.52north.org:8088/geolabel/v4/web/lml/generate_from_gvq_xml/" method="post" enctype="multipart/form-data">
	<hr>
	<br />
