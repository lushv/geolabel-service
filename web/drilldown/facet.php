...
if(!empty($producer_url) && !empty($stylesheet_url)){
...
else if(empty($producer_url) && empty($stylesheet_url)){
	echo '<b>Bad request:</b> XML document\'s location and stylesheet\'s location are not specified.';
}
else if(empty($producer_url)){
	echo '<b>Bad request:</b> XML document\'s location is not specified.';
}
?>